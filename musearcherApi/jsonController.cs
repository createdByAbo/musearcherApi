namespace musearcherApi
{
    ...
    public partial class Result
    {
        ...
        public Artist[] FeaturedArtists { get; set; }
    ...
    public partial class Welcome
    {
        public static Welcome FromJson(string json) => JsonConvert.DeserializeObject<Welcome>(json, musearcherApi.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Welcome self) => JsonConvert.SerializeObject(self, musearcherApi.Converter.Settings);
    }
    //
